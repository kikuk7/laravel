...
<body>
    ...
    <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="<?php echo e(route('admin.pages.index')); ?>" class="list-group-item list-group-item-action">
    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-light" id="navbar-top">
            ...
            <div class="ms-auto d-flex align-items-center">
                <span class="navbar-text me-3">
                    Selamat Datang, <strong><?php echo e(Auth::user()->name); ?></strong> (<?php echo e(Auth::user()->role); ?>)
                </span>
        ...
        <footer class="footer-admin mt-auto">
            <div class="container-fluid">
                <span>&copy; <?php echo e(date('Y')); ?> CV Sumber Alam Raya. All rights reserved.</span>
            </div>
        </footer>
    </div>
...
</html><?php /**PATH E:\JOKI\cobadb\cvadmin\resources\views/layouts/admin_app.blade.php ENDPATH**/ ?>