...
<?php $__env->startSection('title', 'Produk - CV Sumber Alam Raya'); ?> 

<?php $__env->startSection('styles'); ?> 
    <link rel="stylesheet" href="<?php echo e(asset('style/produk.css')); ?>" />
        ...
        <section class="product-section container">
            <div class="product-content">
                ...
                <div class="product-model">
                    ...
                    <model-viewer
                        id="model"
                        src="<?php echo e(asset('assets/Product/KomponenKnalpot3Lobang.glb')); ?>"
                        alt="Model Produk"
                        auto-rotate
                        camera-controls
                        ar
        ...
        const products = [
            {
                ...
                model: "<?php echo e(asset('assets/Product/KomponenKnalpot3Lobang.glb')); ?>",
            ...
            {
                title: "Plendes Mii",
                model: "<?php echo e(asset('assets/Product/KomponenKnalpot2Lobang.glb')); ?>",
            ...
            {
                title: "Matahari",
                model: "<?php echo e(asset('assets/Product/kb.glb')); ?>",
            ...
            },
            {
                ...
                model: "<?php echo e(asset('assets/Product/bintang.glb')); ?>",
            ...
            },
            {
                ...
                model: "<?php echo e(asset('assets/Product/UjungPagar.glb')); ?>",
            ...
            },
            {
                ...
                model: "<?php echo e(asset('assets/Product/KomponenKnalpotkykmangkok.glb')); ?>",
            ...
            {
                title: "Nako Letter S",
                model: "<?php echo e(asset('assets/Product/KomponenPagarS.glb')); ?>",
            ...
            {
                title: "Nako Letter C",
                model: "<?php echo e(asset('assets/Product/kuda.glb')); ?>",
            ...
            },
            {
                ...
                model: "<?php echo e(asset('assets/Product/TangkiKotak.glb')); ?>",
            ...
            },
            {
                ...
                model: "<?php echo e(asset('assets/Product/TangkiBulat.glb')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\JOKI\cobadb\cvadmin\resources\views/frontend/produk.blade.php ENDPATH**/ ?>