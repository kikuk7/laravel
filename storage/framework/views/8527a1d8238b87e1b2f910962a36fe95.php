...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CV Sumber Alam Raya'); ?></title> 
    ...
    <img src="<?php echo e(asset('assets/hero.png')); ?>" alt="" style="display: none;" />
</head>
<body>
    <header>
        <div class="navbar container">
            <div class="logo-container">
                <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Logo" class="logo" />
            </div>

            <nav class="desktop-nav">
                <ul class="nav-links">
                    <li><a href="<?php echo e(url('/')); ?>" class="<?php echo e(request()->is('/') ? 'active' : ''); ?>">beranda</a></li>
                    <li><a href="<?php echo e(url('/tentang')); ?>" class="<?php echo e(request()->is('tentang') ? 'active' : ''); ?>">tentang</a></li>
                    <li><a href="<?php echo e(url('/layanan')); ?>" class="<?php echo e(request()->is('layanan') ? 'active' : ''); ?>">layanan</a></li>
                    <li><a href="<?php echo e(url('/produk')); ?>" class="<?php echo e(request()->is('produk') ? 'active' : ''); ?>">produk</a></li>
                    <li><a href="<?php echo e(url('/galeri')); ?>" class="<?php echo e(request()->is('galeri') ? 'active' : ''); ?>">galeri</a></li>
                </ul>
            </nav>

            <a href="<?php echo e(url('/kontak')); ?>" class="btn-secondary <?php echo e(request()->is('kontak') ? 'active' : ''); ?>">kontak</a>
        </div>
    </header>
    ...
    <section class="contact-section">
        <div class="container contact-grid">
            <div class="kontak-info">
                <h3>Kontak</h3>
                <p class="contact-item"><img src="<?php echo e(asset('assets/icon/email 1.png')); ?>" alt="Email Icon" class="contact-icon"> sumberalam423@gmail.com</p>
                <p class="contact-item"><img src="<?php echo e(asset('assets/icon/telepon.png')); ?>" alt="Phone Icon" class="contact-icon"> +6287801319313</p>
                <p class="contact-item"><img src="<?php echo e(asset('assets/icon/WA.png')); ?>" alt="WA Icon" class="contact-icon"> +6287801319313</p>
            </div>
            ...
            <div class="lokasi-info">
                ...
                <a href="https://wa.me/+6287801319313" class="btn-primary">
                    <img src="<?php echo e(asset('assets/icon/WA.png')); ?>" alt="WhatsApp Icon" class="btn-icon-img"> hubungi kami
                </a>
            </div>

            <div class="pengunjung-info">
                <h3>Pengunjung</h3>
                <p class="visitor-item"><img src="<?php echo e(asset('assets/icon/person.png')); ?>" alt="Online User Icon" class="visitor-icon"> Pengguna Online: <span id="online-user">Memuat...</span></p>
                <p class="visitor-item"><img src="<?php echo e(asset('assets/icon/person.png')); ?>" alt="Visitor Today Icon" class="visitor-icon"> Pengunjung Hari Ini: <span id="today-visitor">Memuat...</span></p>
                <p class="visitor-item"><img src="<?php echo e(asset('assets/icon/person.png')); ?>" alt="Total Visitor Icon" class="visitor-icon"> Total Pengunjung: <span id="total-visitor">Memuat...</span></p>
            </div>
        </div>
    ...
    <footer>
        <div class="footer-container container">
            ...
            <a href="<?php echo e(url('/faq')); ?>" class="faq-link">FAQ <span style="font-weight: bold;">?</span></a>
        </div>
    </footer>
...
</html><?php /**PATH E:\JOKI\cobadb\cvadmin\resources\views/frontend/layouts/main.blade.php ENDPATH**/ ?>