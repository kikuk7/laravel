...
@section('title', 'Edit Produk: ' . $product->name . ' - Admin Dashboard')
            ...
            <div class="card-body">
                <form action="{{ route('admin.products.update', $product->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="model_path" name="model_path" value="{{ old('model_path', $product->model_path) }}" placeholder="Contoh: assets/Product/TangkiKotak.glb" required>
                        @error('model_path')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="specs_json" name="specs_json" rows="5" placeholder='["Bahan: Plat besi", "Tebal: 2mm"]'>{{ old('specs_json', json_encode($product->specs)) }}</textarea>
                        @error('specs_json')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="whatsapp_number" name="whatsapp_number" value="{{ old('whatsapp_number', $product->whatsapp_number) }}" placeholder="+62878xxxxxx">
